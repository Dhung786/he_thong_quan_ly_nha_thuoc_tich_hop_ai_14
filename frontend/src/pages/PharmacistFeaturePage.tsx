          ...
          <div className="mx-auto max-w-5xl">
            <section className="rounded-3xl border border-slate-700/70 bg-[#18253a] p-7 shadow-2xl shadow-slate-950/20 sm:p-9">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <span className="inline-flex rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-1 text-xs font-bold text-emerald-300">
                    GIAO DIỆN DƯỢC SĨ
                  </span>
              ...
              <div className="mt-8 rounded-2xl border border-dashed border-slate-600 bg-slate-950/30 p-6">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Giao diện và route đã được tạo theo vai trò Dược sĩ. Hệ thống chỉ thực hiện thao tác nghiệp vụ thật khi backend tương ứng đã được triển khai, phân quyền và kiểm thử.
                </p>
                {safetyNote && (
                  <p className="mt-4 rounded-xl border border-sky-700/30 bg-sky-950/30 px-4 py-3 text-sm leading-6 text-sky-200/90">
                    {safetyNote}
                  </p>
                )}
              </div>
